...
int main(){
    ...
    */
    ...
    RK_4th_order rk1;
    rk1.SetStepSize(h1);         
    rk1.SetTimeInterval(t0, tn);
    rk1.SetInitialValue(y);
 
    string filename = "rk_output1.csv";     // Filename for output 
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    RK_4th_order rk2;
    rk2.SetStepSize(h2);         
    rk2.SetTimeInterval(t0, tn);
    rk2.SetInitialValue(y);
 
    filename = "rk_output2.csv";     // Filename for output 
